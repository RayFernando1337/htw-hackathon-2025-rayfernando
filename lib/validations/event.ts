...
export const eventSchema = z.object({
  ...
  venue: z.string()
    ...
    .max(200, "Venue name must be under 200 characters"),
...
export const eventDraftSchema = z.object({
  ...
  targetAudience: z.string().max(300, "Target audience description must be under 300 characters").optional(),
